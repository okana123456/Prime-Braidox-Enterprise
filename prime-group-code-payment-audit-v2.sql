-- Prime Braidox group-code payment audit, version 2.
-- READ ONLY: this script does not insert, update, or delete data.
-- It intentionally does not query pb_settings.
